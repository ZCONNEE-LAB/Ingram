...
function getLab(email) {
    ...
    if (index != -1) {
        ...
        table_data += '<p><strong>IMPORTANT: <br>Please DO NOT shutdown the remote Windows system, just close the session. Otherwise you won&apos;t be able to reconnect.</strong></p>';
    }
    $('#lab').html(table_data);
}
